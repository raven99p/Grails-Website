    ...
    <div class="container" style="width: 500px;">
        ...
        <g:form name="loginForm" controller="logReg" action="varif">
            <div class="mb-3">
                ...
                <input type="email" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="true" maxlength="50" ><br/>
                <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
            </div>

            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input name="password" type="password" class="form-control" id="exampleInputPassword1" required="true" maxlength="50" ><br/>
            </div>
