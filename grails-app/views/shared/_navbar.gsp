...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="http://localhost:8080/general/showDepartments#">Postguy</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <g:link controller="Employee" action="createEmployeeForm" id="create_Employee">
                        <button type="button" class="btn btn-link">Create new employee</button>
                    </g:link>
                </li>
                <li class="nav-item">
                    <g:link controller="Department" action="createDeptForm">
                        <button type="button" class="btn btn-link">Create new department</button>
                    </g:link>
                </li>
            </ul>
